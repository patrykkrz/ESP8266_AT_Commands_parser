...
void TIMER_INTERRUPT_FUNCTION_NAME(void) {
    //Call stack function and notifx time update
 ...
 */
#define ESP8266_RESET_INIT    DDRB |= (1 << PINB7)
 ...
 * @note   Declared as macro 
 */
#define ESP8266_RESET_LOW     PORTB &= ~(1 << PINB7)
 ...
 * @note   Declared as macro 
 */
#define ESP8266_RESET_HIGH    PORTB |= (1 << PINB7)
